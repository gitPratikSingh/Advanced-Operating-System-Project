...
void proc1_test4(int* ret) {
  ...
  kprintf("Process 1 going into sleep for 6 seconds\n");
  sleep(6);
  kprintf("Process 1 restarted after sleeping for 6 seconds\n");
...
void test9(){
	int pid1;
	kprintf("Page replacement policy is: %d\n", grpolicy());
